...
namespace Renderer
{
    ...
    inline void Texture::LoadTexture(char const *filepath, bool gammaCorrection)
    {
        this->path = filepath;
    ...
    inline void Texture::TextureFromFile(const char *filepath, const std::string &directory, bool gammaCorrection)
    {
